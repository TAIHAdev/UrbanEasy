  ...
  <body>
    ...
    >
      <div class="flex h-20 justify-between items-center">
        <img
          src="https://i.postimg.cc/D0MhpBST/black-logo-1.png"
          alt="logo"
    ...
    <main class="h-screen">
      ...
      <div class="px-4 md:mx-10 lg:mx-20 xl:mx-40 2xl:mx-96 lg:px-24">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 grid-rows-2 gap-2">
          <img
            ...
            alt=""
            class="col-span-2 row-span-2 rounded"
          />
          <img
          ...
          <div class="col-span-3 row-span-1 shadow-md flex items-center rounded-md">
            <div class="flex flex-col items-center justify-between space-y-2">
              ...
              <div class="flex justify-center items-center space-x-3">
                <img src="/assets/images/king.png" alt="" class="w-1/4 rounded-full">
          ...
          <div class="flex flex-col justify-between">
            <div class="h-32">
              <div class="flex items-center space-x-2">
                <img src="/assets/images/king.png" alt="" class="w-8 rounded-full">
